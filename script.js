...
function appendHistory(original,translation){const entry=document.createElement("article");entry.className="history-entry";const first=document.createElement("p");first.className="history-original";first.textContent=original;const second=document.createElement("p");second.className="history-translation";second.textContent=`（${translation}）`;entry.append(first,second);ui.historyList.append(entry);show(ui.historyPanel);}
