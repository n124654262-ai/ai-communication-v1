...
function appendHistory(translation){const entry=document.createElement("article");entry.className="history-entry";const text=document.createElement("p");text.className="history-ai-translation";text.textContent=translation;entry.append(text);ui.historyList.append(entry);show(ui.historyPanel);}
